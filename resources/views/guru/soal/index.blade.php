            ...
            <div class="section-body   p-2 bg-white rounded">
                ...
                <div>
                    <button type="button" class="btn btn-primary btn-sm tombolAmbil">
                        Ambil Soal Dari Yang Sudah Diujikan
                    </button>
                    ...
                    <div class="shadow p-3 mb-5 bg-body-tertiary rounded mt-2 modalAmbil" id="modalAmbil"
                        ...
                        <div class="content-container">
                            @foreach ($allsMapel as $index => $am)
                                @if ($mapel?->id != $am->id)
                                    <a href="{{ $mapel?->id }}/{{ $am->id }}/banksoal" target="_blank"
                        ...
                        <div class="accordion-body collapse bg-white" id="panel-detail-mapel" data-parent="#accordion">
                            <div class="mb-3 mt-3">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" value="{{ $mapel?->nama_guru }}" name=""
                                            id="" class="form-control bg-white" readonly>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <select name="" disabled multiple="multiple" id="kelas_id"
                                            ...
                                            @foreach ($kelas as $k)
                                                @if (\App\Models\MapelKelas::validate($mapel?->id, $k->id) != null)
                                                    <option
    ...
    <div class="modal fade" id="updateModal" tabindex="-1" aria-labelledby="updateModal" aria-hidden="true">
        <div class="modal-dialog modal-xl">
            <div class="modal-content">
                ...
                <form method="POST" class="needs-validation" id="formUpdate">
                    @csrf
                                    ...
                                    <div class="">
                                        <div class="input-group mb-3">
                                            ...
                                            <input type="text" name="soal_jdh_array[]"
                                                class="form-control font-weight-bold" aria-label="soal_1"
                                                aria-describedby="basic-addon1" id="edit_soal_jdh_array-1">
                                        </div>
                                        <div class="input-group mb-3">
                                            <div class="input-group-prepend">
                                                <span class="input-group-text font-weight-bold bg-primary text-light"
                                            ...
                                            <input type="text" name="soal_jdh_array[]"
                                                class="form-control font-weight-bold" aria-label="soal_2"
                                                aria-describedby="basic-addon1" id="edit_soal_jdh_array-2">
                                        </div>
                                        <div class="input-group mb-3">
                                            <div class="input-group-prepend">
                                                <span class="input-group-text font-weight-bold bg-danger text-light"
                                            ...
                                            <input type="text" name="soal_jdh_array[]"
                                                class="form-control font-weight-bold" aria-label="soal_3"
                                                aria-describedby="basic-addon1" id="edit_soal_jdh_array-3">
                                        </div>
                                        <div class="input-group mb-3">
                                            <div class="input-group-prepend">
                                                <span class="input-group-text font-weight-bold bg-info text-light"
                                            ...
                                            <input type="text" name="soal_jdh_array[]"
                                                class="form-control font-weight-bold" aria-label="soal_4"
                                                aria-describedby="basic-addon1" id="edit_soal_jdh_array-4">
                                        </div>
                                        <div class="input-group mb-3">
                                            <div class="input-group-prepend">
                                                <span class="input-group-text font-weight-bold bg-warning text-light"
                                            ...
                                            <input type="text" name="soal_jdh_array[]"
                                                class="form-control font-weight-bold" aria-label="soal_5"
                                                aria-describedby="basic-addon1" id="edit_soal_jdh_array-5">
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group p-3">
