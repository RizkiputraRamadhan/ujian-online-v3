        ...
        <section class="section">
            <div class="section-body">
                <div class="section-header">
                    <h5><i class="fa-solid fa-folder-open" style="color: orange;"></i> {{ $folder->nama }} true and false</h5> <br>
                                ...
                                <div class="content-container">
                                    <div class="mb-3 mt-3">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="text" value="Soal True And False" id="jenis"
                                                    class="form-control bg-white" readonly>
                                                <input type="text" class="d-none" value="4" name="jenis_soal"
                                                    readonly>
                                            </div>
                                        </div>
